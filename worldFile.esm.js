...
export default function (L) {
  const elmOverly = ElementOverlay(L)
  const WorldFile = elmOverly.extend({
    ...
    initialize: function (options) {
      ...
      this.TRANSFORMORIGIN = L.DomUtil.testProp([
        "TransformOrigin",
    ...
    latlngToContainerPoint: function (latlng) {
      ...
      var pixel_in_container =
        this._map.layerPointToContainerPoint(pixel_on_world);
